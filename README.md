...
Т.е. таким образом полная пересборка проекта так-же настраивает целевое устройство. Теоретически, все эти шаги можно выполнять непосредственно перед запуском отлаживаемого файла, но это несколько увеличивает и без того не малое время запуска. 
...
17/05/2023 20:01:28 [go] Installing to remote host `root@10.113.11.163'
...
```
17/05/2023 20:04:43 [launch-deploy-attach] Building & deploying `onvifd_debug' to remote host http://10.113.11.163
17/05/2023 20:04:43 [launch-deploy-attach] Total runtime: 0.4136s
 *  Terminal will be reused by tasks, press any key to close it. 
```

> Текст `http://10.113.11.163` распознается VSCode как гиперссылка и при его помощи можно быстро открыть браузер по IP адресу устройства.
